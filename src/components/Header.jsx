                        ...
                        <li>
                            <Link to='heart' className='relative'>
                                <div className='w-4 h-4 bg-green-500 rounded-full absolute -right-2 -top-1 flex justify-center items-center'>
                                    <span className='text-10'>{likedCards.length}</span>
                                </div>
                                <svg className='hover:text-green-400 duration-100' fill="currentColor" height="22px" width="22px" version="1.1" id="Capa_1" xmlnsXlink="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
